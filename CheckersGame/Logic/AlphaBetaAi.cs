...
namespace CheckersGame.Logic
{
    ...
    public class AlphaBetaAi : GTArtificialIntelligenceInterface<Element, Position>, IGTArtificialIntelligenceInterface
    {

        GTGameStateGeneratorInterface<Element, Position> generatorFunction;
        GTGameStateHashInterface<Element, Position> hashFunction;
        GTPlayerInterface<Element, Position> maxPlayer;
        const int DEPTH = 4;
